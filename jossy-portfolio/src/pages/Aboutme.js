...
export default function Aboutme(){
    return<div className="about">
        ...
        <div className="aboutparagraph">
            <p className="para" style={{textAlign:"center", lineHeight:"30px",fontFamily:"revert",fontSize:"18px",fontWeight:"400"}}>
                Hi, <span className="im" style={{fontSize:"20",fontWeight:"550"}}>I'm Yosef Tanu</span>, a passionate <span style={{fontSize:"20",fontWeight:"550"}}>front-end developer</span> who loves turning ideas into
               beautiful, responsive, and user-friendly websites.I enjoy crafting clean, efficient code and bringing designes to life to life with  
                ...
                <div className="aboutcard3">
                    ...
                    <div className="pros">
                        ...
                        <div className="htmlcss">
                            ...
                            <span className="pro4">
                                <ul>
                                    <li style={{padding:"15px"}}> Advanced level Calculator app: built with React(include react redux) and JAVASCRIPT</li> 
                                    <li> Simple Taskmanager app: react and JAVASCRIPT</li>
                                </ul> 
                            </span>
                        </div>
